		...
		if ((dwDirection != 0) || (cxDelta != 0.0f) || (cyDelta != 0.0f))
		{
			...
			if (dwDirection)
			{
				...
				if (dwDirection == DIR_LEFT_BACK || dwDirection == DIR_LEFT_FRONT || dwDirection ==  DIR_RIGHT_BACK || dwDirection ==  DIR_RIGHT_FRONT) // 대각선 이동 이동속도 구현
				{
					...
					if (dwDirection == DIR_LEFT_BACK) RotY = 135.0f;
					else if (dwDirection == DIR_LEFT_FRONT) RotY = 45.0f;
					else if (dwDirection == DIR_RIGHT_BACK) RotY = -135.0f;
					else if (dwDirection == DIR_RIGHT_FRONT) RotY = -45.0f;
					m_pScene->pSordmanObject->SetSpeed(m_pScene->pSordmanObject->GetRootSpeed());
					
				}
				else
				{
					if (dwDirection == DIR_LEFT) RotY = 90.0f;
					else if (dwDirection == DIR_RIGHT) RotY = -90.0f;
					else if (dwDirection == DIR_FRONT) RotY = 0.0f;
					else if (dwDirection == DIR_BACK) RotY =  180.0f;
				...
				m_pScene->pSordmanObject->Rotate(0, RotY, 0);
