...
void CGameFramework::SetHeroPosition(float x, float y, float z)
{
	m_pScene->pSordmanObject->SetPosition(x, y, z);
}

void CGameFramework::SetOtherPosition(float x, float y, float z)
{
	m_pScene->pTestObject->SetPosition(x, y, z);
}
