...
void CScene::BuildObjects(ID3D11Device *pd3dDevice)
{
	...
	// ④ 쉐이더에 적용할 메쉬(들) 생성	
	CMesh *pTestMesh = new CFBXMesh(pd3dDevice, "../Data/Sordman/Sordman.data", 0.1f);
	CMesh *pSordManMesh = new CFBXMesh(pd3dDevice, "../Data/Sordman/Sordman.data", 0.1f);
	CMesh *pBuildingMesh = new CFBXMesh(pd3dDevice, "../Data/building/building2/building2.data", 0.1f);
