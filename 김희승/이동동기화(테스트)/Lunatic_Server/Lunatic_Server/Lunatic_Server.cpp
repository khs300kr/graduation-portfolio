...
void SendPositionPacket(int client, int object)
{
	...
	packet.keydown = g_Clients[object].m_bKeydown;
...
{
	//	if (g_Clients[id].m_iZ > 0) g_Clients[id].m_iZ--; break;
	//if (g_Clients[id].m_iZ < BOARD_HEIGHT - 1) g_Clients[id].m_iZ++; break;
	//if (g_Clients[id].m_iX > 0) g_Clients[id].m_iX--; break;
	// if (g_Clients[id].m_iX < BOARD_WIDTH - 1) g_Clients[id].m_iX++; break;
	switch (packet[1])
	{
	case CS_KEYDOWN_UP:   g_Clients[id].m_dwDirection |= DIR_BACK;    g_Clients[id].m_bKeydown = true;            std::cout << g_Clients[id].m_dwDirection << "send to others_Keydown\n";
		break;
	case CS_KEYDOWN_DOWN: g_Clients[id].m_dwDirection |= DIR_FRONT; g_Clients[id].m_bKeydown = true;            std::cout << g_Clients[id].m_dwDirection << "send to others_Keydown\n";
		break;
	case CS_KEYDOWN_LEFT: g_Clients[id].m_dwDirection |= DIR_LEFT;  g_Clients[id].m_bKeydown = true;            std::cout << g_Clients[id].m_dwDirection << "send to others_Keydown\n";
		break;
	case CS_KEYDOWN_RIGHT: g_Clients[id].m_dwDirection |= DIR_RIGHT; g_Clients[id].m_bKeydown = true;            std::cout << g_Clients[id].m_dwDirection << "send to others_Keydown\n";
		break;
	case CS_KEYUP_UP:  g_Clients[id].m_dwDirection ^= DIR_BACK; g_Clients[id].m_bKeydown = false;   std::cout << g_Clients[id].m_dwDirection << "send to others_KeyUp\n";
		break;
	case CS_KEYUP_DOWN:  g_Clients[id].m_dwDirection ^= DIR_FRONT; g_Clients[id].m_bKeydown = false;   std::cout << g_Clients[id].m_dwDirection << "send to others_KeyUp\n";
		break;
	case CS_KEYUP_LEFT:  g_Clients[id].m_dwDirection ^= DIR_LEFT; g_Clients[id].m_bKeydown = false;   std::cout << g_Clients[id].m_dwDirection << "send to others_KeyUp\n";
		break;
	case CS_KEYUP_RIGHT:  g_Clients[id].m_dwDirection ^= DIR_RIGHT; g_Clients[id].m_bKeydown = false;   std::cout << g_Clients[id].m_dwDirection << "send to others_KeyUp\n";
		break;
