...
void ProcessPacket(int id, unsigned char packet[])
{
	...
	switch (packet[1])
	{
	case CS_KEYDOWN_UP:	g_Clients[id].m_dwDirection |= DIR_BACK;	   g_Clients[id].m_bKeydown = true;		std::cout << "send to others_Keydown\n";
		break;																																	
	case CS_KEYDOWN_DOWN: g_Clients[id].m_dwDirection |= DIR_FRONT; g_Clients[id].m_bKeydown = true;		std::cout << "send to others_Keydown\n";
		break;																																	
	case CS_KEYDOWN_LEFT: g_Clients[id].m_dwDirection |= DIR_LEFT;  g_Clients[id].m_bKeydown = true;		std::cout << "send to others_Keydown\n";
		break;																																	
	case CS_KEYDOWN_RIGHT: g_Clients[id].m_dwDirection |= DIR_RIGHT; g_Clients[id].m_bKeydown = true;		std::cout << "send to others_Keydown\n";
		 break;
	case CS_KEYUP: g_Clients[id].m_bKeydown = false;			std::cout << "send to others_KeyUp\n";
		break;
